...
Future run(HookContext context) async {
  ...
  // Order branches alphabetically so the generated imports and exports are ordered and
  // comply with the linting rules.
  final branches = (context.vars['branches'] as List<dynamic>)
      .map((e) => e.trim())
      .toList()
