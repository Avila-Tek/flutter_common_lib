...
/// in the [file] property of all subclasses.
/// {@endtemplate}
abstract class FileUploadedState extends UploadFileState {
  ...
  /// {@endtemplate}
  FileUploadedState.clone(FileUploadedState other) : this(other.file);
...
class ReuploadFileSuccess extends FileUploadedState
  ...
  const ReuploadFileSuccess(super.file);
